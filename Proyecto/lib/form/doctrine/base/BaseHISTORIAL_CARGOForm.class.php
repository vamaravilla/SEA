...
abstract class BaseHISTORIAL_CARGOForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'idcargoxunidadorg'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CARGOXUNIDAD_ORG'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'idcargoxunidadorg'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CARGOXUNIDAD_ORG'))),
