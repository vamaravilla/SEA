...
abstract class BaseACADEMICOForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'idpaisnac'           => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CIUDAD_4'), 'add_empty' => false)),
      'idestadonac'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CIUDAD_3'), 'add_empty' => false)),
      'idciudadnac'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CIUDAD'), 'add_empty' => false)),
      'idpaisciudadania'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PAIS'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'idpaisnac'           => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CIUDAD_4'))),
      'idestadonac'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CIUDAD_3'))),
      'idciudadnac'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CIUDAD'))),
      'idpaisciudadania'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('PAIS'))),
