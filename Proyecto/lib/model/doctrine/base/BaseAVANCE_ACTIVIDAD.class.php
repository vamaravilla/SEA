 ...
 * @method AVANCE_ACTIVIDAD setIdestadoactividad()    Sets the current record's "idestadoactividad" value
 * @method AVANCE_ACTIVIDAD setESTADOACTIVIDAD()      Sets the current record's "ESTADO_ACTIVIDAD" value
