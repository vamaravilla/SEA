 ...
 * @method MATERIA           getMATERIA2()             Returns the current record's "MATERIA_2" value
 ...
 * @method ACADEMICOXMATERIA setIdunidadorganizativa() Sets the current record's "idunidadorganizativa" value
 ...
 * @method ACADEMICOXMATERIA setMATERIA2()             Sets the current record's "MATERIA_2" value
...
abstract class BaseACADEMICOXMATERIA extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('MATERIA as MATERIA_2', array(
