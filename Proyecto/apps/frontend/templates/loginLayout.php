			...
			<div id="contenedor_resto">
				...
				<div id="contenedor_inferior" class="fondo_azul1">
					<div id="pie" class="contenido_centrado">
						...
						<br />Potenciado por <a href="http://www.symfony-project.org/"><img src="images/logos/symfony.png" border="0" /></a> y <a href="http://www.doctrine-project.org/"><img src="images/logos/doctrine.png" border="0" /></a>
						<br /><br />
					</div>
				</div>
			</div>
